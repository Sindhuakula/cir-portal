...
COURSES = (('cse', _('CSE')), ('me', _('ME')), ('ece', _('ECE')), ('eee', _('EEE')),  ('bca', _('BCA')))
...
DIFFICULTY = (('easy', _('EASY')), ('medium', _('MEDIUM')), ('hard', _('HARD')))
...
class Test(models.Model):
    ...
    name = models.CharField(_('Test Name'), max_length=25, unique=False, null=True)
